...
export const homeProjectData = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        date: "2025",
        description: "O Flow é um aplicativo de música que transforma cada momento em uma trilha sonora única. Com uma interface intuitiva e moderna, você pode descobrir novos artistas, criar playlists personalizadas e mergulhar em recomendações inteligentes que se adaptam ao seu estilo.",
        tags: [
          { tag: "UI/UX Design" },
          { tag: "Figma" },
          { tag: "Mobile App" },
