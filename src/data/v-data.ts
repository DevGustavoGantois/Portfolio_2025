...
export const homeProjectData = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        date: "2025",
        description: "Redesign completo da landing page do Headspace com foco em usabilidade e estética. Criei componentes interativos, variantes e organizei o projeto em pastas e subpastas para melhor estrutura e consistência visual.",
        tags: [
          { tag: "UI/UX Design" },
          { tag: "Figma" },
          { tag: "Landing Page" },
