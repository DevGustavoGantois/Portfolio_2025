  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed top-0 left-0 z-[9999] w-14 h-14 rounded-full bg-[#FF6600]/50 text-white flex items-center justify-center text-center pointer-events-none select-none font-normal text-xs"
      >
        {cursorText}
      </motion.div>
    </>
