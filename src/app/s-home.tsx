...
export function HomeHero() {
  return (
    <div className="relative flex h-[40rem] w-full overflow-hidden rounded-md bg-[#0011]/[0.96] antialiased md:items-center md:justify-center">
      <div
        className={cn(
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl p-4 pt-20 md:pt-0">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-2 mt-4">
            <button className="text-white text-base lg:text-xl bg-[#FF6600] py-2 px-6 rounded-2xl">
                <Link href="#projects" className="flex items-center gap-2">
                Projetos
                <Globe className="text-white" size={24} />
                </Link>
            </button>
            <button className="text-white text-base lg:text-xl border border-white/20 bg-black py-2 px-6 rounded-2xl">
                <Link href="#contact">
                Saiba mais
                </Link>
            </button>
