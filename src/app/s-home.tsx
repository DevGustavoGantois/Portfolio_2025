...
export function HomeHero() {
  return (
    <div id="home" className="relative flex text-center h-[35rem] lg:h-[40rem] w-full overflow-hidden rounded-md bg-[#0011]/[0.96] antialiased md:items-center md:justify-center">
      <div
        className={cn(
